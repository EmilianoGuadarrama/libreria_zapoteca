...
@section('dashboard-content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0 text-dark fw-bold">Géneros</h3>
            <button type="button" class="btn btn-link p-0 text-decoration-none fs-2"
                    data-bs-toggle="modal" data-bs-target="#modalCreateGenero"
                    title="Nuevo Género">
    ...
    <div class="modal fade" id="modalCreateGenero" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0" style="background-color: #4b1c71; color: white; border-radius: 20px 20px 0 0;">
                    <h5 class="modal-title bebas fs-4">
                        <i class="fa-solid fa-circle-plus me-2"></i> Nuevo Género
                    </h5>
                ...
                <form action="{{ route('generos.store') }}" method="post">
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b1c71;">Nombre del Género</label>
                            <input type="text" name="nombre" class="form-control" placeholder="Ej. Fantasía, Drama..." required maxlength="100">
                        </div>
                    </div>
    ...
    @foreach($generos as $genero)
        <div class="modal fade" id="modalEditGenero{{ $genero->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                    <div class="modal-header border-0" style="background-color: #4b1c71; color: white; border-radius: 20px 20px 0 0;">
                        <h5 class="modal-title bebas fs-4">
                            <i class="fa-solid fa-pen-to-square me-2"></i> Editar Género
                        </h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <form action="{{ route('generos.update', $genero->id) }}" method="post">
                        ...
                        <div class="modal-body p-4">
                            <div class="mb-3">
                                <label class="form-label fw-bold" style="color: #4b1c71;">Nombre del Género</label>
                                <input type="text" name="nombre" class="form-control" value="{{ $genero->nombre }}" required maxlength="100">
                            </div>
                        </div>
        ...
        <div class="modal fade" id="modalDeleteGenero{{ $genero->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                    ...
                    <div class="modal-body p-4 text-center">
                        <p class="fs-5 mb-1">¿Estás seguro de eliminar el género <br><strong>"{{ $genero->nombre }}"</strong>?</p>
