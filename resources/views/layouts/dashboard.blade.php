...
@section('content')
    ...
    <style>
        ...
        /* Magia CSS para el Acordeón anti-bugs (También globalízalo) */
    ...
    <div class="dashboard-container" style="margin-top: 20px;">
        <aside class="sidebar">
            ...
            <a href="{{ route('mermas.index') }}" class="{{ request()->routeIs('mermas.*') ? 'active' : '' }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fechaMaxima.setFullYear(fechaActual.getFullYear() + 2); // Agrega 2 años al año actual

            flatpickr(".selector-fecha", {
                locale: "es",           // Idioma español
                dateFormat: "Y-m-d",    // Formato compatible con la BD de Laravel
                minDate: "today",       // Bloquea fechas anteriores a hoy
                maxDate: fechaMaxima,   // Bloquea fechas que superen los 2 años
                disableMobile: true     // Mantiene el diseño bonito en celulares
            });
        });
    </script>
