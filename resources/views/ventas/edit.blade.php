...
<body>
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <h1 class="page-title mb-0">Editar venta</h1>
                ...
                <form action="{{ route('ventas.update', $venta->id) }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="folio" id="folio" class="form-control" value="{{ old('folio', $venta->folio) }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="usuario_id" class="form-label">ID Usuario</label>
                            <input type="number" name="usuario_id" id="usuario_id" class="form-control" value="{{ old('usuario_id', $venta->usuario_id) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="monto_recibido" id="monto_recibido" class="form-control" value="{{ old('monto_recibido', $venta->monto_recibido) }}">
                        </div>

                        <div class="col-md-6">
                            <label for="cambio" class="form-label">Cambio</label>
                            <input type="number" step="0.01" name="cambio" id="cambio" class="form-control" value="{{ old('cambio', $venta->cambio) }}">
                        </div>
                    </div>

                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary-custom rounded-pill px-4">Actualizar venta</button>
